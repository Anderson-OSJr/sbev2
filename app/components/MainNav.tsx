...
const MainNav = () => {
  ...
  return (
    <section id="mainNav" className="fixed top-0 left-0 right-0 z-50">
      <div className="h-50 mx-auto max-w-5xl bg-blue-950 flex items-center justify-between px-4 sm:px-8 md:px-10 bg-[url(/balao14.jpg)] bg-contain bg-center bg-no-repeat bg-blend-multiply shadow-md shadow-blue-300">
